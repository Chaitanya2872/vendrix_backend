...
for router in (auth_router, users_router, vendors_router, vehicles_router, drivers_router, invoices_router, payments_router, approvals_router, documents_router, deliveries_router, anpr_router, reports_router, mobile_router, audit_router):
